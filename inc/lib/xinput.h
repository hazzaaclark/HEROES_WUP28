...
#endif 
#ifdef XINPUTTER_EXPORTS
#define XINPUTTER_API __declspec(dllexport)
#else
#define XINPUTTER_API __declspec(dllimport)
#endif
...
extern "C" {
    ...
    XINPUTTER_API DWORD WINAPI XInputGetState
    (
        DWORD         dwUserIndex,  // [in] Index of the gamer associated with the device
        XINPUT_STATE* pState        // [out] Receives the current state
    );

    XINPUTTER_API DWORD WINAPI XInputSetState
    (
        DWORD             dwUserIndex,  // [in] Index of the gamer associated with the device
        XINPUT_VIBRATION* pVibration    // [in, out] The vibration information to send to the controller
    );

    XINPUTTER_API DWORD WINAPI XInputGetCapabilities
    (
        DWORD                dwUserIndex,   // [in] Index of the gamer associated with the device
    ...
    XINPUTTER_API void WINAPI XInputEnable
    (
